...
class ProfileForm(Form):
    ...
    category = SelectMultipleField(_('Categories'), coerce=int)
    tag = SelectMultipleField(_('Select Tags'), coerce=int)
    age_group = SelectMultipleField(_('Age Groups'), coerce=int)
    country = SelectField(_('Country'), choices=[])
    submit = SubmitField(_('Update profile'), render_kw={
                         'class': 'btn btn-primary'})
...
class SearchUsersForm(Form):
    ...
    submit = SubmitField(_('Search'), render_kw={
